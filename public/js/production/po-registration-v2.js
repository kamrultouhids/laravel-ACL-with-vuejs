...
Vue.component('po-registration-list', __webpack_require__(257));
...
Component.options.__file = "resources/js/production/purchase-order/PoRegistrationList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-636c820b", Component.options)
  } else {
    hotAPI.reload("data-v-636c820b", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        editPageUrl: function editPageUrl(id) {
            return base_url + "production/production-po-registration/" + id + "/edit";
        },
        index: function index(pageNo, perPage) {
            ...
            if (pageNo) {
                ...
                pageNo = this.po_registrations.current_page;
            }
            if (perPage) {
                perPage = perPage;
            } else {
            ...
            axios.get(base_url + "production/production-po-registration/?page=" + pageNo + "&perPage=" + perPage).then(function (response) {
                _this2.po_registrations = response.data;
            });
        },
        ...
        deleteData: function deleteData(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    axios.delete(base_url + 'production/production-po-registration/' + id).then(function (response) {
                        _this.index(1);
      ...
      _c("div", { staticClass: "card-body card-dashboard" }, [
        ...
        _c("div", { staticClass: "table-responsive" }, [
          _c(
            ...
            [
              _vm._m(0),
              _vm._v(" "),
              _vm.po_registrations.data != ""
                ? _c(
                    "tbody",
                    _vm._l(_vm.po_registrations.data, function(value, index) {
                      return _c("tr", [
                        _c("td", [_vm._v(_vm._s(++index))]),
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(_vm._s(value.style.buyer.name_of_buyer))
                        ]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(value.style.brand.brand))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(value.po_number))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(value.po_issue_date))]),
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(
                            _vm._s(
                              value.style ? value.style.style_name : "unknown"
                            )
                          )
                        ]),
                        _vm._v(" "),
                        ...
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(_vm._s(value.currency.currency_name))
                        ]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(value.inco_term.name))]),
                        _vm._v(" "),
                        _c("td", [
                          value.status == 1
                            ? _c(
                        ...
                        _c("td", { staticClass: "text-center" }, [
                          _vm.permissions.indexOf(
                            "production-po-registration.destroy"
                          ) != -1
                            ? _c(
                                "a",
                                {
                          ...
                          _vm._v(" "),
                          _vm.permissions.indexOf(
                            "production-po-registration.edit"
                          ) != -1
                            ? _c(
                                "a",
                                {
                                  staticClass: "btn btn-primary btn-sm",
                                  attrs: { href: _vm.editPageUrl(value.id) }
                                },
                                [
                                  _c("i", {
                                    staticClass:
        ...
        _c("div", { staticClass: "row" }, [
          _c(
            ...
            [
              _c("pagination", {
                attrs: { resultData: _vm.po_registrations, "mid-size": 9 },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-636c820b", module.exports)
  }
}
