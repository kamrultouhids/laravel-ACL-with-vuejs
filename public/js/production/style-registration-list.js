...
Vue.component('style-registration-list', __webpack_require__(238));
...
Component.options.__file = "resources/js/production/style-registration/StyleList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-00fba19d", Component.options)
  } else {
    hotAPI.reload("data-v-00fba19d", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        index: function index(pageNo, perPage) {
            ...
            axios.get(base_url + "production/production-style-registration/?page=" + pageNo + "&perPage=" + perPage).then(function (response) {
                _this2.resultData = response.data;
            });
        },
        editData: function editData(id) {
            window.location.href = base_url + 'production/production-style-registration/' + id + '/edit';
        },
        ...
        deleteData: function deleteData(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    axios.delete(base_url + 'production/production-style-registration/' + id).then(function (response) {
                        _this.index(1);
              ...
              ? _c(
                  ...
                  _vm._l(_vm.resultData.data, function(value, index) {
                    return _c("tr", [
                      ...
                      _c("td", [
                        _vm._v(
                          _vm._s(value.buyer ? value.buyer.name_of_buyer : "")
                        )
                      ]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(_vm._s(value.brand ? value.brand.brand : ""))
                      ]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(value.style_name))]),
                      _vm._v(" "),
                      _c("td", [_vm._v(_vm._s(value.style_number))]),
                      _vm._v(" "),
                      _c("td", [
                        _vm._v(
                          _vm._s(
                            value.production ? value.production.item_name : ""
                          )
                        )
                      ]),
                      _vm._v(" "),
                      ...
                      _c("td", { staticClass: "width-200 text-center" }, [
                        _vm.permissions.indexOf(
                          "production-style-registration.destroy"
                        ) != -1
                          ? _c(
                              "a",
                              {
                        ...
                        _vm._v(" "),
                        _vm.permissions.indexOf(
                          "production-style-registration.edit"
                        ) != -1
                          ? _c(
                              "a",
                              {
  ...
  function() {
    ...
    return _c("thead", { staticClass: "table_head" }, [
      _c("tr", [
        ...
        _c("th", [_vm._v("Brand")]),
        _vm._v(" "),
        _c("th", [_vm._v("Style Name")]),
        _vm._v(" "),
        _c("th", [_vm._v("Style Number")]),
        _vm._v(" "),
        _c("th", [_vm._v("Production Item")]),
        _vm._v(" "),
        _c("th", [_vm._v("Status")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-00fba19d", module.exports)
  }
}
