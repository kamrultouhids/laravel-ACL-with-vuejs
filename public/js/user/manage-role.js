...
Vue.component('role-list', __webpack_require__(412));
...
Component.options.__file = "resources/js/user/role/RoleList.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c7fe09f2", Component.options)
  } else {
    hotAPI.reload("data-v-c7fe09f2", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AddRole_vue__ = __webpack_require__(414);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__AddRole_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__AddRole_vue__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        AddRole: __WEBPACK_IMPORTED_MODULE_1__AddRole_vue___default.a,
    ...
    methods: {
        index: function index(pageNo, perPage) {
            ...
            axios.get(base_url + "role/get/?page=" + pageNo + "&perPage=" + perPage).then(function (response) {
        ...
        deleteData: function deleteData(id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    axios.get(base_url + 'role/delete/' + id).then(function (response) {
                        _this.index(1);
...
Component.options.__file = "resources/js/user/role/AddRole.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7a073834", Component.options)
  } else {
    hotAPI.reload("data-v-7a073834", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        store: function store() {
            ...
            axios.post(base_url + 'role/store', this.form).then(function (response) {
                $('#addModel').modal('hide');
        ...
        update: function update(id) {
            ...
            axios.put(base_url + 'role/update/' + id, this.form).then(function (response) {
    ...
    mounted: function mounted() {
        ...
        __WEBPACK_IMPORTED_MODULE_0__vue_assets__["EventBus"].$on('update-button-clicked', function (id) {
            ...
            axios.get(base_url + 'role/edit/' + id).then(function (response) {
                  ...
                  _c("div", { staticClass: "modal-body" }, [
                    _c(
                      "div",
                      {
                        ...
                        class: {
                          "has-danger": _vm.errors.hasOwnProperty("role_name")
                        }
                      },
                      [
                        _vm._m(1),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7a073834", module.exports)
  }
}
                    ...
                    _vm._l(_vm.resultData.data, function(value, index) {
                      return _c("tr", [
                        ...
                        _c("td", { staticClass: "width-200 text-center" }, [
                          _vm.permissions.indexOf("role.destroy") != -1
                            ? _c(
                                "a",
                                {
                          ...
                          _vm.permissions.indexOf("role.edit") != -1
                            ? _c(
                                "a",
                                {
                                  ...
                                  on: {
                                    click: function($event) {
                                      _vm.openUpdateModal(value.role_id)
                                    }
                                  }
                                },
                                [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c7fe09f2", module.exports)
  }
}
