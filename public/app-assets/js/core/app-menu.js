...
/* Create variable for save user menu prefarance */
//sessionStorage.setItem("user_menu", "active");
            ...
            if (this.expanded === false) {
               ...
               */
                this.transit(function() {
                    ...
                    if (sessionStorage.getItem('userMenu') == "active") {
                        $body.removeClass('menu-expanded').addClass('menu-collapsed');
                    } else if(sessionStorage.getItem('userMenu') == "deactive"){
                        $body.removeClass('menu-collapsed').addClass('menu-expanded');
                    }else{
                        sessionStorage.setItem("userMenu", "deactive");
                        $body.removeClass('menu-collapsed').addClass('menu-expanded');
                    }
              ...
              /*if( ($body.data('menu') == 'vertical-menu' ) || ($body.data('menu') == 'vertical-menu-modern' ) ){
               this.changeLogo('collapse');
                ...
                this.transit(function() {
                    ...
                    if(sessionStorage.getItem('userMenu') == 'deactive'){
                        sessionStorage.setItem("userMenu", "active");
                        $body.removeClass('menu-expanded').addClass('menu-collapsed');
                    }else{
                        sessionStorage.setItem("userMenu", "deactive");
                        $body.removeClass('menu-collapsed').addClass('menu-expanded');
